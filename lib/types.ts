...
export const personalityTypes: PersonalityType[] = [
  ...
  {
    code: "ATM-er", cn: "送钱者", slug: "atm-er",
    intro: "你以为我很有钱吗？",
  ...
  {
    code: "THAN-K", cn: "感恩者", slug: "than-k",
    intro: "我感谢苍天！我感谢大地！",
  ...
  {
    code: "LOVE-R", cn: "多情者", slug: "love-r",
    intro: "爱意太满，现实显得有点贫瘠。",
  ...
  {
    code: "THIN-K", cn: "思考者", slug: "thin-k",
    intro: "已深度思考100s。",
    pattern: "HHL-HMH-MLH-MHM-LHH",
    image: img("thin-k"),
