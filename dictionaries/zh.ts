...
const zh: Dictionary = {
  ...
  home: {
    ...
    h1: "SBTI 人格测试在线测试，测测你到底是哪一种抽象人格。",
    desc: "SBTI 现已支持在线测试。现在就可以开始答题，测出自己的 SBTI 人格类型；测完之后，还能继续查看十五维落点和每一种人格的详细解读。",
    startTest: "开始测试",
    browse27: "浏览 27 种人格",
    learnMore: "了解测试说明",
    stat1Label: "15 维模型",
  ...
  test: {
    ...
    desc: "这版测试保留原始 SBTI 题目与结果映射，但交互改成了更像正式产品的单题推进式流程。你完成后会被直接送到对应人格详情页。",
  ...
  types: {
    h1: "27 种 SBTI 人格类型总览",
    desc: "这里收录了全部 SBTI 结果类型。可以先快速浏览每一种人格，也可以直接进入测试页面，看看最后落到哪一种结果上。",
    viewDetail: "查看人格详情",
    startTest: "开始测试",
  },
  rankings: {
  ...
  about: {
    h1: "关于 SBTI 测试",
    desc: "SBTI 是一套轻松向的人格测试。它不会把人塞进非常严肃的术语体系里，而是更关注日常状态、行为倾向和社交反应，让结果读起来更直观。",
    questionsLabel: "题目数量",
    questionsVal: "32 道",
    resultsLabel: "人格结果",
    resultsVal: "27 种",
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        "网上口嗨下就算了，真见面还是有点忐忑。",
        "见网友也挺好，反正谁来聊我就聊两句。",
        "我会打扮一番并热情聊天，万一呢，我是说万一呢？",
      ],
    },
    {
      text: "朋友带了ta的朋友一起来玩，你最可能的状态是",
      options: [
        "对\"朋友的朋友\"天然有点距离感，怕影响二人关系",
        "看对方，能玩就玩。",
        "朋友的朋友应该也算我的朋友！要热情聊天",
      ],
    },
